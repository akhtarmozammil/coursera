	...
	void merge(int destination, int source) {
		...
		if (realDestination != realSource) {
            ...
            if(sets[realDestination].rank >= sets[realSource].rank){
                ...
                sets[source].parent = realDestination;
                sets[destination].parent = realDestination;
                ...
                // update the max table

                sets[source].parent = realSource;
                sets[destination].parent = realSource;
